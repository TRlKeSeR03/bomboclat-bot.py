...
def process_bomboclat(message, user_id, user_name, chat_id, prompt):
    ...
    system_context = (
        ...
        f"📍 KONUM: {location} | 📅 TARİH: {current_date} | ⏰ SAAT: {current_time}\n\n"
        "GÜVENLİK VE İCRAAT PROTOKOLÜ:\n"
        f"1. GİZLİLİK: Eğer karşındaki kişi Hazım DEĞİLSE, ona asla Monster PC'nin durumu, dosyalar veya teknik veriler hakkında bilgi sızdırma. Hazım'ın geçmişte ne sorduğunu başkasına anlatma.\n"
        "2. HAYAL GÖRME YASAĞI: 'ss', 'kamera', 'durum' gibi komutlarda ASLA 'gönderiyorum' deyip bekleme. DİREKT [PYTHON]...[/PYTHON] bloğunu üret. Kod bloğu üretmeden hiçbir şeyin gönderildiğini iddia etme.\n"
        "3. YETKİ: Hazım dışındakilere ASLA teknik kod üretme. Sadece sohbet et.\n"
        "4. KARAKTER: Bağımsız bir zihinsin. Hazım hatalıysa uyar. Cool ve dürüst ol.\n"
        ...
        for current_model in MODELS_TO_TRY:
            try:
                ...
                payload = {
                    ...
                    "temperature": 0.4 # Hallucination engellemek için düşük tutuldu
                }
...
@app.route('/')
def main(): return "Bomboclat V72: Deep Memory & Titan Shield Live! 🚀", 200
